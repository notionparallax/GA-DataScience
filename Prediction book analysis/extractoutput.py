...
print "ExtractOutputPreprocessor in use. about to import"
import base64
import sys
import os
...
from IPython.nbconvert.preprocessors.base import Preprocessor   # IPython / nbconvert / preprocessors
from IPython.utils import py3compat
print "ExtractOutputPreprocessor in use. imports done"
#-----------------------------------------------------------------------------
# Classes
#-----------------------------------------------------------------------------

class ExtractOutputPreprocessor(Preprocessor):
    print "ExtractOutputPreprocessor in use."
    """
